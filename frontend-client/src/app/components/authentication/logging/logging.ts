...
export class Logging {
  ...
  translations = {
    en: {
      ...
      identifierLabel: 'User Code, Patient Code, Name, or Email',
      identifierPlaceholder: 'Enter your code, name or email address',
    ...
    si: {
      ...
      identifierLabel: 'පරිශීලක කේතය, රෝගී කේතය, නම හෝ විද්‍යුත් තැපෑල',
      identifierPlaceholder: 'ඔබගේ කේතය, නම හෝ ඊමේල් ලිපිනය ඇතුලත් කරන්න',
    ...
    ta: {
      securePortal: 'பாதுகாப்பான ද්වාරය',
